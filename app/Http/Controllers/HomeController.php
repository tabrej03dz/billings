...
class HomeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // ✅ Agar user plan click karke register par aaya hai,
            // to direct Razorpay payment page par bhejo.
            // Plan abhi activate/save nahi hoga. Payment success ke baad UserPlan create hoga.
            if ($request->filled('plan_id')) {
                return redirect()->route('razorpay.payment', [
                    'plan_id' => $request->plan_id,
                ])->with('success', 'Registration successful. Please complete payment to activate your plan.');
            }

            // ✅ Agar direct register kiya hai bina plan ke
            return redirect()->route('plan.choose')
                ->with('success', 'Registration successful. Please choose a plan.');
