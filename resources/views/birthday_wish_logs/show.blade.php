<x-layouts.app :title="__('Wish Log Details')">
...
{{--                <a href="{{ route('birthday-wish-logs.edit', $log->id) }}"--}}
            ...
            <div class="lg:col-span-2 p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-neutral-900">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <div class="font-semibold text-gray-900 dark:text-white">{{ $log->wish_year ?? '-' }}</div>
                    </div>
...
{{--                    </div>--}}
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="font-semibold text-gray-900 dark:text-white">{{ optional($log->created_at)->format('d M, Y h:i A') }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-neutral-900">
                ...
                <div class="flex flex-col gap-2">
                    <form method="POST" action="{{ route('birthday-wish-logs.success', $log->id) }}">
                        @csrf
                    ...
                    <form method="POST" action="{{ route('birthday-wish-logs.failed', $log->id) }}">
                        @csrf
                    ...
                    <form method="POST" action="{{ route('birthday-wish-logs.destroy', $log->id) }}"
