<x-layouts.app :title="__('Permissions & Roles')">
    ...
    >
        ...
        >
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                >
                    ...
                    >
                        <path
                            d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1
                               1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1
                               0 011-1z"
                        />
                    </svg>
                ...
                >
                    ...
                    >
                        <path
                            d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1
                               1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1
                               1 0 011-1z"
                        />
                    </svg>
        ...
        <form
            id="assignForm"
            action="{{ route('permissions.assign') }}"
            method="POST"
            class="space-y-6"
        >
            ...
            >
                ...
                <div class="grid md:grid-cols-3 gap-4">
                        ...
                        >
                            ...
                            @foreach($users as $user)
                                ...
                                @php
                                    ...
                                    /*
                                    |--------------------------------------------------------------------------
                                    | Business display string
                                    |--------------------------------------------------------------------------
                                    |
                                    | Example:
                                    |
                                    | Real Victory Groups [Owner]
                                    | GPT Groups [Staff]
                                    |
                                    */

                                    $businessText = $user->businesses
                                    ...
                                    /*
                                     * Legacy business relation fallback
                                     */
                                    if (
                                        blank($businessText) &&
                                        $user->business
                                    ) {
                                        $businessText = $user->business->name;
                                    }
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option
                                value="web"
                                {{ old('guard_name', 'web') === 'web' ? 'selected' : '' }}
                            >
                                web
                            </option>
                ...
                >
                    User, Role, ya dono me se jo select karoge,
                    selected permissions us target par assign ho jayengi.
                </p>
            ...
            >
                ...
                <table
                    class="min-w-full divide-y
                           divide-gray-200 dark:divide-neutral-700"
                >
            ...
            >
                ...
                <div class="p-5 text-center">
                    ...
                    <div class="flex justify-center gap-3">
                        ...
                        <form
                            :action="`{{ route('permissions.destroy', ':id') }}`.replace(
                                ':id',
                                selectedPermission ?? ''
                            )"
                            method="POST"
            ...
            >
                ...
                <div class="p-5 text-center">
                    ...
                    <div class="flex justify-center gap-3">
                        ...
                        <form
                            :action="`{{ route('roles.destroy', ':id') }}`.replace(
                                ':id',
                                selectedRole ?? ''
                            )"
                            method="POST"
        ...
        function permissionRolePage() {
            ...
            return {
                ...
                init() {
                    ...
                    /*
                     * Guard change par doosre guard ki
                     * selected permissions hata do.
                     */
                    const guardSelect =
                        document.getElementById('guard_name');

                    if (guardSelect) {

                        guardSelect.addEventListener(
                            'change',
                            () => {
                                this.filterPermissionsByGuard();
                            }
                        );
                    ...
                    document
                        ...
                        .forEach((checkbox) => {
                            ...
                            const permissionGuard =
                                checkbox.dataset.guard;

                            /*
                             * Sirf currently selected guard
                             * ki permissions select hongi.
                             */
                            if (
                                !permissionGuard ||
                                permissionGuard === selectedGuard
                            ) {
                ...
                filterPermissionsByGuard() {
                    ...
                    document
                        ...
                        .forEach((checkbox) => {
                            ...
                            /*
                             * Wrong guard wali selected permission
