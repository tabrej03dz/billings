<x-layouts.app :title="__('Businesses')">
    <div class="flex flex-col gap-4">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('businesses.create') }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-green-600 bg-blue-600 rounded-lg hover:bg-blue-700">
                + New Business
            </a>
        </div>
        ...
        <div class="overflow-auto rounded-xl border border-gray-200 dark:border-gray-700">
            <table class="min-w-full text-sm text-left text-gray-700 dark:text-gray-300">
                ...
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">GSTIN</th>
                ...
                @forelse ($businesses as $business)
                    <tr>
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">{{ $business->name }}</td>
