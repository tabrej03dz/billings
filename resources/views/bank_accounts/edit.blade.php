<x-layouts.app :title="__('Edit Bank Account')">
    <div class="max-w-3xl mx-auto">
        <div class="flex items-center justify-between mb-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Bank Account</h1>
        ...
        <div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-neutral-900 p-5">
            <form action="{{ route('bank-accounts.update', $bankAccount->id) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
