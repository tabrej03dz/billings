@extends('backend.layout.root', ['title' => 'Edit Bank Account'])
    ...
    <div class="max-w-4xl mx-auto px-3 py-5">
        ...
        <div class="bg-white rounded-2xl shadow p-4 sm:p-6">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <h1 class="text-xl font-extrabold text-slate-900">Edit Bank Account</h1>
                    <p class="text-sm text-slate-500 mt-1">Update bank/UPI details.</p>
                </div>
