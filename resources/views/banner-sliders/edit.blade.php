<x-layouts.app :title="__('Edit Banner Slider')">
    <div class="flex flex-col gap-4">

        <div class="flex items-center justify-between bg-[#BFE0E0] dark:bg-[#354A54] p-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Banner Slider</h1>
        ...
        <form action="{{ route('banner-sliders.update', $bannerSlider->id) }}"
              method="POST"
