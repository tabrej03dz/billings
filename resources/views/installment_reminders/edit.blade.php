<x-layouts.app :title="__('Edit Installment Reminder')">
        ...
        <div class="flex items-center justify-between gap-3">
            <div>
                ...
                <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-1">
                    Update installment reminder details.
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('installment-reminders.update', $installmentReminder) }}" class="grid gap-4 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="contact_number"
                           value="{{ old('contact_number', $installmentReminder->contact_number) }}"
                ...
                <div>
                    ...
                    <input type="text" name="snme_number"
                           value="{{ old('snme_number', $installmentReminder->snme_number) }}"
                           class="w-full rounded-lg border border-slate-200 bg-white text-sm text-slate-900
                                  focus:ring-indigo-500 focus:border-indigo-500
                                  dark:bg-slate-950 dark:text-slate-100 dark:border-slate-700 dark:focus:border-indigo-400">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="reminder_date"
                           value="{{ old('reminder_date', optional($installmentReminder->reminder_date)->format('Y-m-d')) }}"
                           class="w-full rounded-lg border border-slate-200 bg-white text-sm text-slate-900
                                  focus:ring-indigo-500 focus:border-indigo-500
                                  dark:bg-slate-950 dark:text-slate-100 dark:border-slate-700 dark:focus:border-indigo-400">
                </div>
                ...
                <div>
                    ...
                    <input type="time" name="reminder_time"
                           value="{{ old('reminder_time', \Carbon\Carbon::parse($installmentReminder->reminder_time)->format('H:i')) }}"
                           class="w-full rounded-lg border border-slate-200 bg-white text-sm text-slate-900
                                  focus:ring-indigo-500 focus:border-indigo-500
                                  dark:bg-slate-950 dark:text-slate-100 dark:border-slate-700 dark:focus:border-indigo-400">
                </div>
                ...
                <div>
                    ...
                    <input type="date" name="installment_date"
                           value="{{ old('installment_date', optional($installmentReminder->installment_date)->format('Y-m-d')) }}"
                           class="w-full rounded-lg border border-slate-200 bg-white text-sm text-slate-900
                                  focus:ring-indigo-500 focus:border-indigo-500
                                  dark:bg-slate-950 dark:text-slate-100 dark:border-slate-700 dark:focus:border-indigo-400">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="installment_amount"
                           value="{{ old('installment_amount', $installmentReminder->installment_amount) }}"
                           class="w-full rounded-lg border border-slate-200 bg-white text-sm text-slate-900
                                  focus:ring-indigo-500 focus:border-indigo-500
                                  dark:bg-slate-950 dark:text-slate-100 dark:border-slate-700 dark:focus:border-indigo-400">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <select name="status"
                            class="w-full rounded-lg border border-slate-200 bg-white text-sm text-slate-900
                                   focus:ring-indigo-500 focus:border-indigo-500
                                   dark:bg-slate-950 dark:text-slate-100 dark:border-slate-700 dark:focus:border-indigo-400">
                        <option value="uploaded" {{ old('status', $installmentReminder->status) === 'uploaded' ? 'selected' : '' }}>Uploaded</option>
                        <option value="sent" {{ old('status', $installmentReminder->status) === 'sent' ? 'selected' : '' }}>Sent</option>
                        <option value="failed" {{ old('status', $installmentReminder->status) === 'failed' ? 'selected' : '' }}>Failed</option>
                    </select>
                </div>
