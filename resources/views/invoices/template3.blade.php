@php
    ...
    $primaryColor   = $templateSetting->primary_color ?? '#1d4ed8';
    $textColor      = $templateSetting->text_color ?? '#1e293b';
    $mutedColor     = $templateSetting->muted_color ?? '#475569';
    $borderColor    = $templateSetting->border_color ?? '#cbd5e1';
    $secondaryColor = $templateSetting->secondary_color ?? '#e2e8f0';
    $lightBgColor   = $templateSetting->light_bg_color ?? '#eff6ff';
