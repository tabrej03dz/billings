...
.title{text-align:center;font-size:20px;font-weight:700;border-bottom:2px solid #000;padding:8px;background:#f5f5f5}
table{width:100%;border-collapse:collapse}
td,th{border:1px solid #000;padding:6px;vertical-align:top}
.headName{font-size:18px;font-weight:700}
.items th{background:#e5e5e5;text-align:left}
.text-right{text-align:right}
.desc{font-size:10px;color:#333}
.summary{width:100%}
.summary .grand td{font-weight:700;background:#e5e5e5}
...
<div class="form">
    ...
    <table>
        <tr>
            <td style="width:15%">
                @if(!empty($logo))
                    <img src="{{ $logo }}" style="max-width:80px;max-height:60px;">
                @endif
            </td>
            <td style="width:55%">
                <div class="headName">{{ $b->name ?? 'Real Victory Groups' }}</div>
    ...
    <table>
        <tr>
            <td style="width:60%">
                ...
                @if(!empty($inv->terms))
                    <br><br><strong>Terms:</strong><br>{!! nl2br(e($inv->terms)) !!}
                @endif
            </td>
            <td class="sign">
