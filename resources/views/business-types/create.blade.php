<x-layouts.app :title="__('Create Business Type')">
    <div class="flex flex-col gap-4">

        <div class="flex items-center justify-between mb-4 bg-[#BFE0E0] dark:bg-[#354A54] p-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Create Business Type</h1>
                            ...
                            <div class="border rounded-lg p-3 dark:border-neutral-700">
                                ...
                                <label class="flex items-center gap-2 mt-2 text-xs text-gray-500 dark:text-gray-400">
                                    <input type="checkbox"
                                           ...
                                           value="{{ $field }}"
                                           {{ in_array($field, old('required_fields', [])) ? 'checked' : '' }}>
                                    <span>Required</span>
                                </label>
                            </div>
                        @endforeach
