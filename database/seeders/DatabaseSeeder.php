...
//        ]);
        ...
        Permission::create(['name' => 'show invoices menu']);
        ...
        Permission::create(['name' => 'convert into tax invoice']);
        Permission::create(['name' => 'show proformas']);
        Permission::create(['name' => 'create proforma']);
        Permission::create(['name' => 'edit proforma']);
        Permission::create(['name' => 'delete proforma']);
